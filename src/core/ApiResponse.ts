...
enum StatusCode {
	...
	EMAIL_NOT_VERIFIED = '10005',
	SUBSCRIPTION_INACTIVE = '10006',
}
...
export class EmailNotVerifiedResponse extends ApiResponse {
	constructor(message = 'Email not verified') {
		super(StatusCode.EMAIL_NOT_VERIFIED, ResponseStatus.FORBIDDEN, message);
	}
}

export class SubscriptionErrorResponse extends ApiResponse {
	constructor(message = 'Subscription Error') {
		super(StatusCode.SUBSCRIPTION_INACTIVE, ResponseStatus.FORBIDDEN, message);
	}
}
