...
export enum ErrorType {
	...
	SUBSCRIPTION_ERROR = 'SubscriptionErrorResponse',
}
...
export abstract class ApiError extends Error {
	...
	public static handle(err: ApiError, res: Response): Response {
		switch (err.type) {
			case ErrorType.EMAIL_NOT_VERIFIED:
				return new EmailNotVerifiedResponse(err.message).send(res);
...
export class EmailNotVerifiedError extends ApiError {
	constructor(message = 'Email is not verified') {
		super(ErrorType.EMAIL_NOT_VERIFIED, message);
	}
}
